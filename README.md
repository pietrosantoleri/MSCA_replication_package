...
The original empirical data are confidential. **This package uses fully synthetic data.** It runs the analyses for the three main figures and two main tables using generated artificial records. Numerical results may differ from the paper.
...
Script [06](scripts/06_export_tables.do) inserts the estimates from scripts 03 and 04 into the manuscript table layouts stored under `scripts/`.
