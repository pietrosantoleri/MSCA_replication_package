...
| --- | --- | --- |
| rdrobust, rdplot, rdbwselect and Mata support | Sebastian Calonico, Matias D. Cattaneo, Max H. Farrell and Rocío Titiunik, as credited by individual files | GPL-3.0; [upstream notice](documentation/third_party_licenses/rdrobust.txt), [full licence](documentation/third_party_licenses/GPL-3.0.txt) |
| binscatter, including fastxtile | Michael Stepner | CC0 1.0 notice embedded in `stata_packages/b/binscatter.ado` |
| coefplot | Ben Jann | MIT; [licence](documentation/third_party_licenses/coefplot.txt) |
| estout family (eststo, estadd and support) | Ben Jann | MIT; [licence](documentation/third_party_licenses/estout.txt) |
...
See [DEPENDENCIES.md](documentation/DEPENDENCIES.md) for the bundled command versions. Stata itself is proprietary and is not distributed here.
